...
var SponsorsService = (function () {
    function SponsorsService() {
    }
    SponsorsService.prototype.getSponsors = function () {
        return require('../../model/sponsors.json');
    };
    SponsorsService.prototype.getByCategory = function (cat) {
        var sponsorCategory = [];
